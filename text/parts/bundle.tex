...
Далее, заметим что для любого $x$, $s(x + \iu y) \le s(\iu y)$. \todo{How to prove? We could probably take a look at numerator and denominator in separate?}. После всех вышеупомянутых замечаний, для $s(x + \iu y)$ можно дать довольно простую нижнюю оценку:
...
Так как $s_1$ вогнута, строго возрастает, и для фиксированного $r$, нас интересуют только $y \le C + R$, мы можем оценить функцию линейной: \mtodo{plot?}
\[
s_4(y) = 
